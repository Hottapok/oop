...
public class Main {
    public static void main(String[] args) {
        ...
        getInfo(anna);
 //       task 2
        Car car1 = new Car("Lada", "Grande", 1.7, "Желтый", 2015, "Россия","Auto",null,"x012zx012",2 ,"Лето");
...
//        getInfoAboutCars(car5);
        ...
        getInfo(bouqet);
        Car.Insurance car1Insurance = car1.new Insurance(2022,17500,"789456123");
    ...
    public static void getInfoAboutCars(Car car) {
        System.out.println(car.getBrand() + " " + car.getModel() + " " + ",год выпуска " + car.getYear()
                ...
                car.getNumberOfSeats()+", резина "+ car.getTire());
    }
